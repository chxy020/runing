...
public class SportListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
            ...
            //获取控件对象   
			ImageView runtyV = (ImageView)convertView.findViewById(R.id.list_sport_type);   
            ImageView mindV  = (ImageView)convertView.findViewById(R.id.list_sport_mind);  
            ImageView wayV  = (ImageView)convertView.findViewById(R.id.list_sport_way);  
            TextView dateyV  = (TextView)convertView.findViewById(R.id.list_sport_date);  
            TextView disyV  = (TextView)convertView.findViewById(R.id.list_sport_distance);  
            TextView spedV  = (TextView)convertView.findViewById(R.id.list_sport_speed);  
