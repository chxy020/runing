...
import android.widget.ViewFlipper;
    public class SelectHeight extends PopupWindow implements OnClickListener {  
        ...
        private void updateheight(WheelView view) {  
        	...
        	heightAdapter = new HeightNumericAdapter(mContext, 50, 240, view.getCurrentItem());  
        ...
        private class HeightNumericAdapter extends NumericWheelAdapter {  
             ...
             * Constructor 
             */  
            public HeightNumericAdapter(Context context, int minValue, int maxValue, int current) {  
